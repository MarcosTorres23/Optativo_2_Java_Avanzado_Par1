...
public class Cuentas extends javax.swing.JFrame {
    ...
    private Cuentas_servicios cuentasService;
    /**
    ...
    public Cuentas() {
        ...
        cuentasService = new Cuentas_servicios("postgres", "0000", "localhost", "5432", "BaseDatos_Examen_OptativoII");
    }

    private void ConsultarCuenta(String filtrarPor, String filtro) {
        switch (filtrarPor) {
            case "id":
                cargarDato(cuentasService.consultarCuentaPorId(Integer.parseInt(filtro)));
                break;   
            default:
...
private void cargarDato(Cuentas_modelo model){
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(196, 189, 215));
    ...
    private void txtidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidKeyPressed
        // TODO add your handling code here:
         if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER){
            ...
            ConsultarCuenta("id", txtid.getText().trim());
            }
        else{
